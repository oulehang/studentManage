...
<head>
	...
	<script type="text/javascript" src="${basePath}/easyui/themes/locale/easyui-lang-zh_CN.js"></script>
	...
	$(function() {
	    ...
	    $('#dataList').datagrid({
	        ...
	        fit: true,//自动大小
	        method: "post",
	        url:"${basePath}/exam/teacherExamList",
	        idField:'id',
	        ...
	        columns: [[
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'etime',title:'考试时间',width:170},
	    ...
	    $("#add").click(function(){
	    	$.ajax({
				type: "post",
				url: "${basePath}/teacher/getTeacher",
				dataType: "json",
            	...
            	if(exam.type == 2){
            		$("#regClazzList").combobox("readonly", true);
               		...
               		setTimeout(function(){
                		...
                		//加载数据
    			    	setTimeout(function(){
    				    	$("#regEscoreList").datagrid("options").url = "${basePath}/score/scoreList";
	            	...
	            	$("#regClazzList").combobox("options").url = "${basePath}/teacher/getExamClazz";
	    ...
	    $("#escore").click(function(){
        	...
        	if(exam == null){
            	...
            	setTimeout(function(){
			    	$("#escoreList").datagrid("options").url = "${basePath}/score/scoreList";
	    ...
	    $("#regEscoreDialog").dialog({
	  	...
	  	$("#redo").click(function(){
        	...
        	var url = "${basePath}/score/exportScore?id="+exam.id+"&gradeid="+exam.gradeid+"&clazzid="+clazzid+"&courseid="+exam.courseid+"&type="+exam.type;
	  	...
	  	$("#regClazzList").combobox({
	  		...
	  		onChange: function(newValue, oldValue){
	  			...
	  			$("#regCourseList").combobox("options").url = "${basePath}/teacher/getExamCourse";
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6"  >
	    		...
	    		<tr>
	    			<td>考试<br/>时间:</td>
	    			<td><input id="add_time" style="width: 200px; height: 30px;" class="easyui-datetimebox" type="text" name="etime" data-options="required:true, missingMessage:'请选择日期', editable:false" /></td>
	    		</tr>
	    		<tr>
	    			<td>考试<br/>类型:</td>
	    			<td>
