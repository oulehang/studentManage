...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"${basePath}/teacher/teacherList",
	        idField:'id', 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除"+selectLength +"位教师相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	  ...
	  //下拉框通用属性
	  	...
	  	$("#add_courseList").combobox({
	  		url: "${basePath}/course/courseList2",
	  		onLoadSuccess: function(){
		  		//默认选择第一条数据
				var data = $(this).combobox("getData");;
				$(this).combobox("setValue", data[0].id);
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="edit" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">查看或修改</a></div>
			<div style="float: left;" class="datagrid-btn-separator"></div>
	...
	<div id="addDialog" style="padding: 10px;">  
   		<div style=" position: absolute; margin-left: 560px; width: 250px; height: 300px; border: 1px solid #EEF4FF" id="photo">
    		<img alt="照片" style="max-width: 250px; max-height: 300px;" title="照片" src="${basePath}/photo/teacher.jpg" />
	    </div> 
