    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"教学管理",
							"menus":[
									{"menuid":"11","menuname":"成绩查询","icon":"icon-find","url":"${basePath}/student/toExamStudentView"},
								]
						},
						{"menuid":"2","icon":"","menuname":"班级信息",
							"menus":[
									{"menuid":"21","menuname":"班级通讯录","icon":"icon-note","url":"${basePath}/student/toStudentNoteListView"},
								]
						},
						{"menuid":"3","icon":"","menuname":"系统管理",
							"menus":[
							        {"menuid":"31","menuname":"个人信息","icon":"icon-password","url":"${basePath}/student/toStudentPersonalView"},
								]
						}
				]};
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head"><span style=" font-weight:bold;" id="username1">${user.name}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="${basePath}/login/loginOut"  id="loginOut">安全退出</a></span>
