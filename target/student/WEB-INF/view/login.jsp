...
<head>
    ...
    <link href="${basePath}/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
    <link href="${basePath}/h-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" />
    <link href="${basePath}/h-ui/lib/icheck/icheck.css" rel="stylesheet" type="text/css" />
    <link href="${basePath}/h-ui/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="${basePath}/login/getVCode?time="+new Date().getTime();
		});
			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
						...
						window.location.href = "${basePath}/login/adminView";
					} else if("student" == msg){
						window.location.href = "${basePath}/login/studentView";
					} else if("teacher" == msg){
						window.location.href = "${basePath}/login/teacherView";
					}
				}
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="${basePath}/login/getVCode"></div>
      </div>
